  ...
  {/***************  PODCASTS *************/}
    ...
    {/************* *********** LIST OF BLOGS **********************/}
              ...
              >
                {
                  data.map((blog,index) => (
                    <div key={index} className="flex flex-1 flex-col items-center justify-start my-0 w-full border-b-2 border-slate-800">
                      <div className="flex flex-col items-start justify-start w-full">
                       ...
                       {/*  <div className="flex sm:flex-col flex-row font-publicsans gap-[50px] items-center justify-start mt-5 w-[65%] md:w-full">
                        ...
                        <Button
                          className="common-pointer cursor-pointer flex items-center justify-center min-w-[255px] mt-5 mb-5 pl-7 py-[5px]"
 ...
 {/******************** *   CATEGORIES *********************/}
              <div className="flex flex-col font-merriweather gap-5 items-start justify-start w-full">
                ...
                <div className="flex flex-col font-publicsans gap-2.5 items-center justify-start w-full">
                  ...
                  <div className="bg-bluegray-100 h-[0.5px] w-full" ></div>
                  <div className="flex flex-row items-center justify-between w-full">
                    <Text
                      className="text-bluegray-600 text-lg"
                      size="txtPublicSansLight18Bluegray600"
                  ...
                  <div className="bg-bluegray-100 h-[0.5px] w-full" />
                  <div className="flex flex-row items-center justify-between w-full">
                    <Text
                      className="text-bluegray-600 text-lg"
                      size="txtPublicSansLight18Bluegray600"
